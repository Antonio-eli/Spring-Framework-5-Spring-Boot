...
import com.mx.roancoder.app.item.models.Producto;
...
public class ItemServiceImpl implements ItemService{
	...
	public List<Item> findAll() {
		List<Producto> productos = Arrays.asList(clienteRest.getForObject("http://localhost:8080/listar", Producto[].class));
